...
| app/api/v1/agenda/vinculos/route.ts, components/agenda/VinculoDaMarcacao.tsx | Busca do paciente ao marcar por nome, telefone, CPF (hash) ou nascimento, com fim do telefone e nascimento para homônimos | (E1) |
