...
export const DICIONARIO: Traducoes = {
  ...
  // ── FORK clinic: Agenda do dia ──
  "Cada profissional com a ocupação, os horários livres e o status de cada paciente, com filtros.": { es: "Cada profesional con la ocupación, los horarios libres y el estado de cada paciente, con filtros." },
  "Manhã": { es: "Mañana" },
  "Tarde": { es: "Tarde" },
  "Noite": { es: "Noche" },
  "Fora da jornada": { es: "Fuera de la jornada" },
  "Lotado": { es: "Completo" },
  "A Agenda do dia está desligada nesta empresa.": { es: "La Agenda del día está desactivada en esta empresa." },
  "A tela Agenda do dia mostra cada profissional com a ocupação, os horários livres e o status de cada paciente, com filtros.": { es: "La pantalla Agenda del día muestra a cada profesional con la ocupación, los horarios libres y el estado de cada paciente, con filtros." },
  "Abrir compromisso (remarcar ou cancelar)": { es: "Abrir cita (reprogramar o cancelar)" },
  "Agenda do dia": { es: "Agenda del día" },
  "Agenda do dia desligada": { es: "Agenda del día desactivada" },
  "Agenda do dia ligada": { es: "Agenda del día activada" },
  "atualizado para": { es: "actualizado a" },
  "Buscar paciente": { es: "Buscar paciente" },
  "Cada profissional com a ocupação, os horários livres e o status de cada paciente. Atualiza sozinha.": { es: "Cada profesional con la ocupación, los horarios libres y el estado de cada paciente. Se actualiza sola." },
  "consulta": { es: "consulta" },
  "consultas": { es: "consultas" },
  "Dia anterior": { es: "Día anterior" },
  "Escolher dia": { es: "Elegir día" },
  ...
  "horários na lista": { es: "horarios en la lista" },
  "Ligar em Configurações › Profissionais": { es: "Activar en Configuración › Profesionales" },
  "Ligue para usar a tela Agenda do dia: um profissional por bloco, ocupação, horários livres e o status de cada paciente.": { es: "Active para usar la pantalla Agenda del día: un profesional por bloque, ocupación, horarios libres y el estado de cada paciente." },
  "livre": { es: "libre" },
  "Livre": { es: "Libre" },
  "livres": { es: "libres" },
  "Marcar": { es: "Agendar" },
  ...
  "ocupado": { es: "ocupado" },
  "Paciente: nome, CPF ou nascimento (dd/mm/aaaa)": { es: "Paciente: nombre, CPF o nacimiento (dd/mm/aaaa)" },
  "Período do dia": { es: "Período del día" },
  "Próximo dia": { es: "Día siguiente" },
