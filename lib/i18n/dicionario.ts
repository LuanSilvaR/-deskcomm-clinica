...
export const DICIONARIO: Traducoes = {
  ...
  "A agenda só oferece quem tem a especialidade exigida e respeita os bloqueios abaixo.": { es: "La agenda solo ofrece a quien tiene la especialidad exigida y respeta los bloqueos de abajo." },
  "Agenda de": { es: "Agenda de" },
  "Às": { es: "A las" },
  "Até (opcional)": { es: "Hasta (opcional)" },
  "Atende pela agenda": { es: "Atiende por la agenda" },
  "Atendimentos": { es: "Atenciones" },
  "Bloquear": { es: "Bloquear" },
  "Bloqueios": { es: "Bloqueos" },
  "Bloqueios de agenda": { es: "Bloqueos de agenda" },
  "Cadastre especialidades na aba Especialidades.": { es: "Registra especialidades en la pestaña Especialidades." },
  "Clínica toda": { es: "Toda la clínica" },
  "Conselho": { es: "Consejo profesional" },
  "Criar ficha": { es: "Crear ficha" },
  "dia inteiro": { es: "día completo" },
  "Dia inteiro": { es: "Día completo" },
  "Editar ficha": { es: "Editar ficha" },
  "Especialidades": { es: "Especialidades" },
  "Ex.: Harmonização facial": { es: "Ej.: Armonización facial" },
  "Feche um período (férias, congresso), um horário que se repete toda semana ou a clínica toda num feriado. O que já estava marcado continua marcado.": { es: "Cierra un período (vacaciones, congreso), un horario que se repite cada semana o toda la clínica en un feriado. Lo que ya estaba agendado sigue agendado." },
  "Horário de atendimento": { es: "Horario de atención" },
  "Marque as especialidades que cada tipo de atendimento exige. A agenda, a tela de marcar e o agente de IA passam a oferecer só profissionais habilitados.": { es: "Marca las especialidades que exige cada tipo de atención. La agenda, la pantalla de agendar y el agente de IA pasan a ofrecer solo profesionales habilitados." },
  "Minha agenda": { es: "Mi agenda" },
  "Não foi possível carregar as especialidades.": { es: "No fue posible cargar las especialidades." },
  "Não foi possível carregar os bloqueios.": { es: "No fue posible cargar los bloqueos." },
  "Não foi possível carregar os profissionais.": { es: "No fue posible cargar los profesionales." },
  "Não foi possível carregar os tipos de atendimento.": { es: "No fue posible cargar los tipos de atención." },
  "Nenhum bloqueio em vigor.": { es: "Ningún bloqueo vigente." },
  "Nenhum membro na equipe ainda.": { es: "Todavía no hay miembros en el equipo." },
  "Nenhum tipo de atendimento cadastrado. Crie em Tipos de agendamento.": { es: "No hay tipos de atención registrados. Créalos en Tipos de agendamiento." },
  "Nenhuma especialidade cadastrada ainda.": { es: "Todavía no hay especialidades registradas." },
  "Nova especialidade": { es: "Nueva especialidad" },
  "Número do registro": { es: "Número de registro" },
  "O que cada profissional sabe fazer. Um atendimento que exige uma especialidade só é marcado com quem a tem.": { es: "Lo que sabe hacer cada profesional. Una atención que exige una especialidad solo se agenda con quien la tiene." },
  "Profissionais": { es: "Profesionales" },
  "Profissionais e especialidades": { es: "Profesionales y especialidades" },
  "Profissional": { es: "Profesional" },
  "Qualquer profissional pode atender.": { es: "Cualquier profesional puede atender." },
  "Quem atende, o que cada um sabe fazer, quando atende e quando a agenda fica fechada.": { es: "Quién atiende, qué sabe hacer cada uno, cuándo atiende y cuándo la agenda queda cerrada." },
  "Quem atende, o que cada um faz, quando atende e quando a agenda fica fechada.": { es: "Quién atiende, qué hace cada uno, cuándo atiende y cuándo la agenda queda cerrada." },
  "Quem pode fazer cada atendimento": { es: "Quién puede hacer cada atención" },
  "Regras de profissionais desligadas": { es: "Reglas de profesionales desactivadas" },
  "Regras de profissionais ligadas": { es: "Reglas de profesionales activadas" },
  "Repetir só nestes dias da semana (opcional)": { es: "Repetir solo en estos días de la semana (opcional)" },
  "sem ficha": { es: "sin ficha" },
  "Só quem administra a empresa liga ou desliga.": { es: "Solo quien administra la empresa activa o desactiva." },
  "Só quem tem uma das especialidades marcadas.": { es: "Solo quien tiene una de las especialidades marcadas." },
  ...
  // ── FORK clinic: Contato passa a se chamar Paciente ──
  "Anonimizar paciente": { es: "Anonimizar paciente" },
  "Anonimizar paciente (LGPD)": { es: "Anonimizar paciente (LGPD)" },
  "Atualize os dados deste paciente.": { es: "Actualiza los datos de este paciente." },
  "Criar paciente": { es: "Crear paciente" },
  "Customer 360 — busque, filtre e gerencie pacientes.": { es: "Customer 360 — busca, filtra y gestiona pacientes." },
  "Editar paciente": { es: "Editar paciente" },
  "Erro ao carregar paciente.": { es: "Error al cargar el paciente." },
  "Erro ao carregar pacientes.": { es: "Error al cargar los pacientes." },
  "Este paciente já foi anonimizado": { es: "Este paciente ya fue anonimizado" },
  "Excluir paciente": { es: "Eliminar paciente" },
  "Excluir paciente?": { es: "¿Eliminar paciente?" },
  "Importar pacientes de planilha": { es: "Importar pacientes desde una hoja de cálculo" },
  "Juntar pacientes": { es: "Unir pacientes" },
  "Memória do paciente": { es: "Memoria del paciente" },
  "Mostrando os duplicados entre os pacientes mais antigos. Junte estes e reabra para ver os próximos.": { es: "Mostrando los duplicados entre los pacientes más antiguos. Únelos y vuelve a abrir para ver los siguientes." },
  "Nenhum paciente duplicado encontrado.": { es: "No se encontró ningún paciente duplicado." },
  "Novo paciente": { es: "Nuevo paciente" },
  "paciente": { es: "paciente" },
  "Paciente": { es: "Paciente" },
  "Paciente anonimizado (LGPD)": { es: "Paciente anonimizado (LGPD)" },
  "Paciente anonimizado.": { es: "Paciente anonimizado." },
  "Paciente atualizado": { es: "Paciente actualizado" },
  "Paciente criado": { es: "Paciente creado" },
  "Paciente excluído.": { es: "Paciente eliminado." },
  "Paciente já estava anonimizado, e não faltava nada.": { es: "El paciente ya estaba anonimizado y no faltaba nada." },
  "paciente(s) importado(s)": { es: "paciente(s) importado(s)" },
  "pacientes": { es: "pacientes" },
  "Pacientes": { es: "Pacientes" },
  "Pacientes duplicados": { es: "Pacientes duplicados" },
  "Pacientes juntados.": { es: "Pacientes unidos." },
  "Pacientes juntados. {n} registro(s) continuaram no cadastro antigo — veja a auditoria.": { es: "Pacientes unidos. {n} registro(s) siguieron en el registro antiguo — revisa la auditoría." },
  "Selecione uma conversa para ver detalhes do paciente.": { es: "Selecciona una conversación para ver los detalles del paciente." },
  "será absorvido e sai da lista de pacientes. Mensagens, negócios e histórico passam para quem fica. Não há como desfazer.": { es: "será absorbido y sale de la lista de pacientes. Mensajes, negocios e historial pasan a quien se queda. No se puede deshacer." },
  "Tags do paciente": { es: "Etiquetas del paciente" },
  "Ver paciente": { es: "Ver paciente" },
  "Fale com uma lista de pacientes que você escolhe, no ritmo do número.": { es: "Habla con una lista de pacientes que eliges, al ritmo del número." },
  // ── FORK clinic (migration 9002): ficha do paciente e chegada ──
  "A clínica exige a ficha cadastral completa para registrar a chegada. Ao salvar completa, a chegada é registrada.": { es: "La clínica exige la ficha de registro completa para registrar la llegada. Al guardarla completa, la llegada se registra." },
  "Complete a ficha do paciente": { es: "Completa la ficha del paciente" },
  "CPF": { es: "CPF" },
  "CPF cadastrado — digite só para trocar": { es: "CPF registrado — escríbelo solo para cambiarlo" },
  "CPF do responsável": { es: "CPF del responsable" },
  "Ficha completa": { es: "Ficha completa" },
  "Ficha completa. O paciente pode ser atendido.": { es: "Ficha completa. El paciente puede ser atendido." },
  "Ficha do paciente": { es: "Ficha del paciente" },
  "Ficha do paciente exigida na chegada": { es: "Ficha del paciente exigida a la llegada" },
  "Ficha do paciente não é exigida": { es: "La ficha del paciente no es obligatoria" },
  "Ficha incompleta": { es: "Ficha incompleta" },
  "Ficha incompleta — falta preencher": { es: "Ficha incompleta — falta completar" },
  "Ligue para exigir a ficha cadastral completa ao registrar a chegada e o comparecimento.": { es: "Actívalo para exigir la ficha de registro completa al registrar la llegada y la asistencia." },
  "\"Paciente chegou\" e \"Compareceu\" só são registrados com a ficha cadastral completa.": { es: "\"El paciente llegó\" y \"Asistió\" solo se registran con la ficha de registro completa." },
  "Não foi possível carregar a ficha do paciente.": { es: "No fue posible cargar la ficha del paciente." },
  "não informado": { es: "no informado" },
  "Paciente chegou": { es: "El paciente llegó" },
  "Paciente chegou às": { es: "El paciente llegó a las" },
  "Salvar ficha": { es: "Guardar ficha" },
  "Nome social (opcional)": { es: "Nombre social (opcional)" },
  "Data de nascimento": { es: "Fecha de nacimiento" },
  "Sexo": { es: "Sexo" },
  "E-mail (opcional)": { es: "Correo electrónico (opcional)" },
  "RG (opcional)": { es: "Documento de identidad (opcional)" },
  "Órgão emissor (opcional)": { es: "Órgano emisor (opcional)" },
  "UF do RG (opcional)": { es: "Estado del documento (opcional)" },
  "CEP": { es: "Código postal" },
  "Logradouro": { es: "Calle" },
  "Complemento (opcional)": { es: "Complemento (opcional)" },
  "Bairro": { es: "Barrio" },
  "Cidade": { es: "Ciudad" },
  "Código IBGE do município (opcional)": { es: "Código IBGE del municipio (opcional)" },
  "Contato de emergência": { es: "Contacto de emergencia" },
  "Parentesco": { es: "Parentesco" },
  "Responsável legal (paciente menor de idade)": { es: "Responsable legal (paciente menor de edad)" },
  "Nome do responsável": { es: "Nombre del responsable" },
  "Parentesco do responsável": { es: "Parentesco del responsable" },
  "Perfil (opcional)": { es: "Perfil (opcional)" },
  "Profissão": { es: "Profesión" },
  "Estado civil": { es: "Estado civil" },
  "Como conheceu a clínica": { es: "Cómo conoció la clínica" },
  "Selecione": { es: "Selecciona" },
  "Feminino": { es: "Femenino" },
  "Masculino": { es: "Masculino" },
  "Intersexo": { es: "Intersexo" },
  "Prefere não informar": { es: "Prefiere no informar" },
  "Solteiro(a)": { es: "Soltero(a)" },
  "Casado(a)": { es: "Casado(a)" },
  "União estável": { es: "Unión estable" },
  "Separado(a)": { es: "Separado(a)" },
  "Divorciado(a)": { es: "Divorciado(a)" },
  "Viúvo(a)": { es: "Viudo(a)" },
  "Parentesco do contato de emergência": { es: "Parentesco del contacto de emergencia" },
  "Telefone do contato de emergência": { es: "Teléfono del contacto de emergencia" },
  "Paciente não encontrado.": { es: "Paciente no encontrado." },
  "Este agendamento não tem paciente vinculado.": { es: "Esta cita no tiene paciente vinculado." },
  "Este agendamento foi cancelado.": { es: "Esta cita fue cancelada." },
  "Complete a ficha do paciente antes de registrar a chegada.": { es: "Completa la ficha del paciente antes de registrar la llegada." },
  "Telefone do contato de emergência inválido.": { es: "Teléfono del contacto de emergencia inválido." },
  "Não foi possível proteger o CPF agora.": { es: "No fue posible proteger el CPF ahora." },
  ...
  // ── FORK clinic: melhorias da Agenda ──
  "Paciente, CPF ou nascimento": { es: "Paciente, CPF o nacimiento" },
  "Manhã": { es: "Mañana" },
  "Tarde": { es: "Tarde" },
  "Noite": { es: "Noche" },
  "Fora da jornada": { es: "Fuera de la jornada" },
  "Lotado": { es: "Completo" },
  "Nada com esses filtros.": { es: "Nada con estos filtros." },
  "Especialidade": { es: "Especialidad" },
  "Somente horários livres": { es: "Solo horarios libres" },
  "Filtros da agenda": { es: "Filtros de la agenda" },
  "Buscar paciente": { es: "Buscar paciente" },
  "Todas as especialidades": { es: "Todas las especialidades" },
  "Mostrar os status": { es: "Mostrar los estados" },
  "Período do dia": { es: "Período del día" },
  "Filtros ativos": { es: "Filtros activos" },
  "Remover filtro": { es: "Quitar filtro" },
  "compromissos com os filtros": { es: "citas con los filtros" },
  "consulta": { es: "consulta" },
  "consultas": { es: "consultas" },
  "ocupado": { es: "ocupado" },
  "Ocupação do dia": { es: "Ocupación del día" },
  "Status de": { es: "Estado de" },
  "atualizado para": { es: "actualizado a" },
  "Não foi possível carregar a agenda do dia.": { es: "No fue posible cargar la agenda del día." },
  "Nenhum profissional com agenda aberta nesta data.": { es: "Ningún profesional con agenda abierta en esta fecha." },
  "livre": { es: "libre" },
  "livres": { es: "libres" },
  "Livre": { es: "Libre" },
  "Marcar": { es: "Agendar" },
  "Nenhum horário com esses filtros.": { es: "Ningún horario con estos filtros." },
  "Horários de": { es: "Horarios de" },
  "Sem paciente": { es: "Sin paciente" },
  ...
  // ── FORK clinic: Início da recepção ──
  "a atender": { es: "por atender" },
  "A atender": { es: "Por atender" },
  "Ações rápidas": { es: "Acciones rápidas" },
  "Agendar agora": { es: "Agendar ahora" },
  "Atrasado": { es: "Atrasado" },
  "Boa noite": { es: "Buenas noches" },
  "Boa tarde": { es: "Buenas tardes" },
  "Bom dia": { es: "Buenos días" },
  "Buscando…": { es: "Buscando…" },
  "Buscar paciente: nome, CPF ou nascimento": { es: "Buscar paciente: nombre, CPF o nacimiento" },
  "Confirmar para amanhã": { es: "Confirmar para mañana" },
  "Filtrar os pacientes de hoje": { es: "Filtrar los pacientes de hoy" },
  "Nenhum paciente encontrado.": { es: "Ningún paciente encontrado." },
  "Nenhum paciente neste filtro.": { es: "Ningún paciente en este filtro." },
  "Ninguém esperando agora.": { es: "Nadie esperando ahora." },
  "Paciente cadastrado.": { es: "Paciente registrado." },
  "Pacientes de hoje": { es: "Pacientes de hoy" },
  "Sala de espera": { es: "Sala de espera" },
  "Sem vagas livres no resto do dia.": { es: "Sin horarios libres el resto del día." },
  "Todos os módulos": { es: "Todos los módulos" },
  "Tudo confirmado para amanhã.": { es: "Todo confirmado para mañana." },
  "tudo o que a recepção precisa para o dia": { es: "todo lo que la recepción necesita para el día" },
  "Vagas livres hoje": { es: "Horarios libres hoy" },
  "A chegar": { es: "Por llegar" },
  "Na sala de espera": { es: "En la sala de espera" },
  ...
  "Aprovar esta versão? Depois de aprovada, ela não pode mais ser editada — só por uma nova versão.": { es: "¿Aprobar esta versión? Después de aprobada ya no se puede editar — solo mediante una nueva versión." },
  "Aprove a primeira versão antes de criar uma nova.": { es: "Apruebe la primera versión antes de crear una nueva." },
  "As alterações são salvas sozinhas.": { es: "Los cambios se guardan solos." },
  "Comece pelo modelo com as seções usuais ou por um documento em branco. Depois, edite à vontade.": { es: "Empiece por el modelo con las secciones habituales o por un documento en blanco. Después, edite libremente." },
  "Confirme a verificação em duas etapas para esta ação.": { es: "Confirme la verificación en dos pasos para esta acción." },
  "Conteúdo do POP": { es: "Contenido del POP" },
  "Criado por": { es: "Creado por" },
  "Criar rascunho da nova versão": { es: "Crear borrador de la nueva versión" },
  "Dados do documento": { es: "Datos del documento" },
  "Descartar este rascunho? A versão vigente continua valendo.": { es: "¿Descartar este borrador? La versión vigente sigue valiendo." },
  "Descartar rascunho": { es: "Descartar borrador" },
  "Desfazer": { es: "Deshacer" },
  "Documento em branco": { es: "Documento en blanco" },
  "em vez de": { es: "en lugar de" },
  "Erro ao salvar — tente de novo.": { es: "Error al guardar — intente de nuevo." },
  "Escreva o POP aqui…": { es: "Escriba el POP aquí…" },
  "Esta versão já foi aprovada e não pode ser alterada. Crie uma nova versão.": { es: "Esta versión ya fue aprobada y no se puede modificar. Cree una nueva versión." },
  "Este procedimento ainda não tem POP.": { es: "Este procedimiento aún no tiene POP." },
  "Este procedimento já tem um POP.": { es: "Este procedimiento ya tiene un POP." },
  "Ex.: atualização dos EPIs": { es: "Ej.: actualización de los EPP" },
  "Formatação do documento": { es: "Formato del documento" },
  "Há um texto deste rascunho que não chegou a ser salvo neste navegador.": { es: "Hay un texto de este borrador que no llegó a guardarse en este navegador." },
  "Inserir tabela": { es: "Insertar tabla" },
  "Itálico": { es: "Cursiva" },
  "Já existe um POP com esse código.": { es: "Ya existe un POP con ese código." },
  "Já existe uma versão em rascunho. Termine ou descarte antes de criar outra.": { es: "Ya existe una versión en borrador. Termínela o descártela antes de crear otra." },
  "Linha horizontal": { es: "Línea horizontal" },
  "Lista com marcadores": { es: "Lista con viñetas" },
  "Lista numerada": { es: "Lista numerada" },
  "Motivo da revisão": { es: "Motivo de la revisión" },
  "Não foi possível carregar o POP.": { es: "No fue posible cargar el POP." },
  "Negrito": { es: "Negrita" },
  "Nova versão criada em rascunho.": { es: "Nueva versión creada en borrador." },
  "Outra pessoa alterou este rascunho": { es: "Otra persona modificó este borrador" },
  "Outra pessoa alterou este rascunho. Recarregue para ver a versão atual.": { es: "Otra persona modificó este borrador. Recargue para ver la versión actual." },
  "Parágrafo": { es: "Párrafo" },
  "POP": { es: "POP" },
  "POP criado em rascunho (versão 1.0).": { es: "POP creado en borrador (versión 1.0)." },
  "POP não encontrado.": { es: "POP no encontrado." },
  "Procedimento operacional padrão — POP": { es: "Procedimiento operativo estándar — POP" },
  "Quebra de página": { es: "Salto de página" },
  "Quem tem permissão para editar POP pode criar.": { es: "Quien tiene permiso para editar el POP puede crearlo." },
  "Rascunho descartado.": { es: "Borrador descartado." },
  "Recarregar": { es: "Recargar" },
  "Recuperar": { es: "Recuperar" },
  "Refazer": { es: "Rehacer" },
  "Remover coluna": { es: "Quitar columna" },
  "Remover linha": { es: "Quitar fila" },
  "Remover tabela": { es: "Quitar tabla" },
  "Revisão maior": { es: "Revisión mayor" },
  "Salvo às": { es: "Guardado a las" },
  "Seu texto está guardado neste navegador; recarregue para ver a versão atual.": { es: "Su texto está guardado en este navegador; recargue para ver la versión actual." },
  "Sublinhado": { es: "Subrayado" },
  "Substituído": { es: "Sustituido" },
  "Título 1": { es: "Título 1" },
  "Título 2": { es: "Título 2" },
  "Título 3": { es: "Título 3" },
  "Última atualização": { es: "Última actualización" },
  "Usar modelo padrão": { es: "Usar modelo estándar" },
  "Versão aprovada. Agora ela é a vigente.": { es: "Versión aprobada. Ahora es la vigente." },
  "Versão substituída — não é a vigente.": { es: "Versión sustituida — no es la vigente." },
  "Vigente": { es: "Vigente" },
  "O documento passou do tamanho máximo (1 MB).": { es: "El documento superó el tamaño máximo (1 MB)." },
  "O documento tem um elemento que o editor não permite.": { es: "El documento tiene un elemento que el editor no permite." },
  "O documento é grande demais.": { es: "El documento es demasiado grande." },
  "Documento inválido.": { es: "Documento inválido." },
  "Conteúdo inválido.": { es: "Contenido inválido." },
  "Escolha o modelo padrão ou o documento em branco.": { es: "Elija el modelo estándar o el documento en blanco." },
  "O motivo da revisão tem no máximo 500 caracteres.": { es: "El motivo de la revisión tiene como máximo 500 caracteres." },
  "Não há rascunho para descartar.": { es: "No hay borrador para descartar." },
  "Pedido inválido.": { es: "Solicitud inválida." },
  "O que a clínica realiza, quem pode realizar e o POP de cada procedimento.": { es: "Lo que realiza la clínica, quién puede realizarlo y el POP de cada procedimiento." },
  "A clínica cadastra os procedimentos, liga cada um às especialidades e profissionais, e mantém o POP versionado e imprimível.": { es: "La clínica registra los procedimientos, vincula cada uno a las especialidades y profesionales, y mantiene el POP versionado e imprimible." },
  "Apto": { es: "Apto" },
  "Ativos": { es: "Activos" },
  "Buscar procedimento": { es: "Buscar procedimiento" },
  "Cadastrar procedimento": { es: "Registrar procedimiento" },
  "Código interno": { es: "Código interno" },
  "Dados gerais": { es: "Datos generales" },
  "Descrição breve": { es: "Descripción breve" },
  "Descrição detalhada": { es: "Descripción detallada" },
  "Duração entre 5 e 600 minutos.": { es: "Duración entre 5 y 600 minutos." },
  "Duração estimada (minutos)": { es: "Duración estimada (minutos)" },
  "Especializações": { es: "Especializaciones" },
  "Inativos": { es: "Inactivos" },
  "Informe a descrição breve.": { es: "Informe la descripción breve." },
  "Ligar em Configurações › Profissionais": { es: "Activar en Configuración › Profesionales" },
  "Ligue para cadastrar os procedimentos da clínica com o POP de cada um (versões, aprovação e impressão).": { es: "Active para registrar los procedimientos de la clínica con el POP de cada uno (versiones, aprobación e impresión)." },
  "Não foi possível carregar os procedimentos.": { es: "No fue posible cargar los procedimientos." },
  "Nenhum procedimento cadastrado ainda.": { es: "Ningún procedimiento registrado todavía." },
  "Nenhum procedimento com esse filtro.": { es: "Ningún procedimiento con ese filtro." },
  "Nenhum profissional cadastrado. Cadastre em Configurações › Profissionais.": { es: "Ningún profesional registrado. Regístrelo en Configuración › Profesionales." },
  "Nenhuma especialização cadastrada. Cadastre em Configurações › Profissionais.": { es: "Ninguna especialización registrada. Regístrela en Configuración › Profesionales." },
  "Nome ou código": { es: "Nombre o código" },
  "Novo procedimento": { es: "Nuevo procedimiento" },
  "Os procedimentos da clínica, quem pode realizar cada um e o POP de cada procedimento.": { es: "Los procedimientos de la clínica, quién puede realizar cada uno y el POP de cada procedimiento." },
  "Os procedimentos que a clínica realiza, quem pode realizar cada um e o POP de cada procedimento.": { es: "Los procedimientos que realiza la clínica, quién puede realizar cada uno y el POP de cada procedimiento." },
  "Procedimento cadastrado.": { es: "Procedimiento registrado." },
  "Procedimento não encontrado.": { es: "Procedimiento no encontrado." },
  "Procedimento salvo.": { es: "Procedimiento guardado." },
  "Procedimentos e POP desligados": { es: "Procedimientos y POP desactivados" },
  "Procedimentos e POP estão desligados nesta empresa.": { es: "Procedimientos y POP están desactivados en esta empresa." },
  "Procedimentos e POP ligados": { es: "Procedimientos y POP activados" },
  "profissionais": { es: "profesionales" },
  "Profissionais sem a especialização serão retirados ao salvar.": { es: "Los profesionales sin la especialización se quitarán al guardar." },
  "profissional": { es: "profesional" },
  "Qualquer especialização": { es: "Cualquier especialización" },
  "Sem especialização marcada, qualquer profissional pode ser vinculado.": { es: "Sin especialización marcada, cualquier profesional puede vincularse." },
  "Sem nenhuma das especializações do procedimento": { es: "Sin ninguna de las especializaciones del procedimiento" },
  "Sem POP": { es: "Sin POP" },
  "Há profissional sem nenhuma das especialidades do procedimento.": { es: "Hay un profesional sin ninguna de las especialidades del procedimiento." },
  "Especialidade ou profissional não encontrado.": { es: "Especialidad o profesional no encontrado." },
  "Vínculos inválidos.": { es: "Vínculos inválidos." },
  ...
  "Papel": { es: "Rol" },
  "Todos os papéis": { es: "Todos los roles" },
  "Sem papel": { es: "Sin rol" },
  "Convidar membro": { es: "Invitar miembro" },
  "sem papel": { es: "sin rol" },
  "convites em aberto": { es: "invitaciones abiertas" },
  "Nenhum colaborador encontrado com esta busca.": { es: "Ningún colaborador encontrado con esta búsqueda." },
  "Nenhum membro com este papel.": { es: "Ningún miembro con este rol." },
  "Convidar": { es: "Invitar" },
  "Peça a quem administra a equipe para convidar esta pessoa.": { es: "Pida a quien administra el equipo que invite a esta persona." },
  "Nível usado pelas telas que ainda não perguntam a permissão": { es: "Nivel usado por las pantallas que aún no consultan el permiso" },
  "Nível": { es: "Nivel" },
  "Alterar papéis": { es: "Cambiar roles" },
  "Ver permissões": { es: "Ver permisos" },
  "Papéis deste membro": { es: "Roles de este miembro" },
  "Convite pendente": { es: "Invitación pendiente" },
  "Convite expirado": { es: "Invitación vencida" },
  "Entra como": { es: "Entra como" },
  "Ver na Equipe": { es: "Ver en Equipo" },
  "Visualizador": { es: "Visualizador" },
  "Papéis de acesso": { es: "Roles de acceso" },
  "Quem pode fazer o quê: papéis da empresa, permissões e os papéis de cada membro.": { es: "Quién puede hacer qué: roles de la empresa, permisos y los roles de cada miembro." },
  "Quem pode fazer o quê na empresa. Crie papéis como Recepcionista ou Financeiro, marque as permissões e dê a cada membro um ou mais papéis.": { es: "Quién puede hacer qué en la empresa. Cree roles como Recepcionista o Finanzas, marque los permisos y asigne a cada miembro uno o más roles." },
  "Marcadas junto, porque são necessárias": { es: "Marcadas también, porque son necesarias" },
  "Desmarcadas junto, porque dependiam desta": { es: "Desmarcadas también, porque dependían de esta" },
  "O papel Administrador é do sistema: não muda de nome e nunca perde o controle dos papéis e da equipe.": { es: "El rol Administrador es del sistema: no cambia de nombre y nunca pierde el control de los roles y del equipo." },
  "Novo papel": { es: "Nuevo rol" },
  "permissões": { es: "permisos" },
  "membros": { es: "miembros" },
  "cópia": { es: "copia" },
  "Permissões efetivas": { es: "Permisos efectivos" },
  "Salvar papéis": { es: "Guardar roles" },
  "Acesso pelos papéis desta tela": { es: "Acceso por los roles de esta pantalla" },
  "Acesso pelo papel de sempre": { es: "Acceso por el rol de siempre" },
  "Cada membro pode exatamente o que os papéis dele permitem. O papel antigo passa a ser calculado sozinho.": { es: "Cada miembro puede exactamente lo que sus roles permiten. El rol antiguo pasa a calcularse solo." },
  "Hoje vale Administrador, Gerente, Atendente ou Visualizador, escolhido na Equipe. Prepare os papéis e ligue quando estiver pronto — ninguém perde acesso ao ligar.": { es: "Hoy vale Administrador, Gerente, Agente o Visualizador, elegido en Equipo. Prepare los roles y actívelo cuando esté listo — nadie pierde acceso al activarlo." },
  "Papéis": { es: "Roles" },
  "Acesso não autorizado": { es: "Acceso no autorizado" },
  "Seu papel de acesso não inclui esta tela. Fale com quem administra a empresa.": { es: "Su rol de acceso no incluye esta pantalla. Hable con quien administra la empresa." },
  "Funis e negócios": { es: "Embudos y negocios" },
  "Campanhas e automações": { es: "Campañas y automatizaciones" },
  "Agentes de IA": { es: "Agentes de IA" },
  "Canais (WhatsApp)": { es: "Canales (WhatsApp)" },
  "Profissionais, especialidades e salas": { es: "Profesionales, especialidades y salas" },
  "Relatórios e indicadores": { es: "Informes e indicadores" },
  "Auditoria": { es: "Auditoría" },
  "Ver a agenda, os horários livres e os compromissos": { es: "Ver la agenda, los horarios libres y las citas" },
  "Remarcar compromisso": { es: "Reprogramar cita" },
  "Cancelar compromisso": { es: "Cancelar cita" },
  "Registrar \"Compareceu\" ou \"Faltou\"": { es: "Registrar \"Asistió\" o \"No asistió\"" },
  "Bloquear horários e dias na agenda": { es: "Bloquear horarios y días en la agenda" },
  "Tipos de atendimento, lembretes e prazos da agenda": { es: "Tipos de atención, recordatorios y plazos de la agenda" },
  "Ver o painel da recepção e o status das visitas": { es: "Ver el panel de recepción y el estado de las visitas" },
  "Avançar o status da visita (chegou, pronto, em atendimento, finalizado)": { es: "Avanzar el estado de la visita (llegó, listo, en atención, finalizado)" },
  "Voltar o status da visita (correção com motivo)": { es: "Retroceder el estado de la visita (corrección con motivo)" },
  "Ver pacientes e o histórico": { es: "Ver pacientes y el historial" },
  "Cadastrar paciente": { es: "Registrar paciente" },
  "Juntar cadastros duplicados": { es: "Unir registros duplicados" },
  "Ver a ficha cadastral (CPF, endereço, responsável)": { es: "Ver la ficha de registro (CPF, dirección, responsable)" },
  "Preencher e alterar a ficha cadastral": { es: "Completar y modificar la ficha de registro" },
  "Ver as conversas": { es: "Ver las conversaciones" },
  "Responder e iniciar conversas": { es: "Responder e iniciar conversaciones" },
  "Assumir, transferir e liberar conversas": { es: "Asumir, transferir y liberar conversaciones" },
  "Encerrar e adiar conversas": { es: "Cerrar y posponer conversaciones" },
  "Notas internas nas conversas": { es: "Notas internas en las conversaciones" },
  "Criar e editar respostas rápidas": { es: "Crear y editar respuestas rápidas" },
  "Ver funis e negócios": { es: "Ver embudos y negocios" },
  "Criar negócio": { es: "Crear negocio" },
  "Editar e mover negócio": { es: "Editar y mover negocio" },
  "Criar e alterar funis e etapas": { es: "Crear y modificar embudos y etapas" },
  "Ver tarefas": { es: "Ver tareas" },
  "Criar, editar e concluir tarefas": { es: "Crear, editar y completar tareas" },
  "Ver campanhas e automações": { es: "Ver campañas y automatizaciones" },
  "Criar, enviar e pausar campanhas e automações": { es: "Crear, enviar y pausar campañas y automatizaciones" },
  "Ver agentes de IA e o que fizeram": { es: "Ver agentes de IA y lo que hicieron" },
  "Configurar agentes, conhecimento e follow-ups": { es: "Configurar agentes, conocimiento y seguimientos" },
  "Credenciais, publicação e orçamento de IA": { es: "Credenciales, publicación y presupuesto de IA" },
  "Conectar e configurar o WhatsApp e outros canais": { es: "Conectar y configurar WhatsApp y otros canales" },
  "Ver lançamentos, comandas e fidelidade": { es: "Ver asientos, comandas y fidelidad" },
  "Abrir comanda, lançar itens e finalizar": { es: "Abrir comanda, cargar ítems y finalizar" },
  "Estornar comanda e excluir lançamento": { es: "Revertir comanda y eliminar asiento" },
  "Catálogo financeiro e regras": { es: "Catálogo financiero y reglas" },
  "Ver produtos": { es: "Ver productos" },
  "Cadastrar, importar e alterar produtos": { es: "Registrar, importar y modificar productos" },
  "Ver profissionais, especialidades e salas": { es: "Ver profesionales, especialidades y salas" },
  "Cadastrar profissionais, especialidades, salas e exigências": { es: "Registrar profesionales, especialidades, salas y exigencias" },
  "Ver desempenho e faltas": { es: "Ver desempeño y ausencias" },
  "Ver indicadores gerenciais da agenda": { es: "Ver indicadores gerenciales de la agenda" },
  "Ver a equipe e os convites": { es: "Ver el equipo y las invitaciones" },
  "Convidar e reenviar convites": { es: "Invitar y reenviar invitaciones" },
  "Revogar e reativar acesso de membros": { es: "Revocar y reactivar el acceso de miembros" },
  "Dar e tirar papéis de acesso dos membros": { es: "Asignar y quitar roles de acceso a los miembros" },
  "Ver os papéis de acesso e as permissões": { es: "Ver los roles de acceso y los permisos" },
  "Criar, editar, duplicar, desativar e excluir papéis": { es: "Crear, editar, duplicar, desactivar y eliminar roles" },
  "Ver as configurações da empresa": { es: "Ver la configuración de la empresa" },
  "Alterar configurações da empresa (roteamento, campanhas, marca)": { es: "Modificar la configuración de la empresa (enrutamiento, campañas, marca)" },
  "Ligar e desligar as opções da clínica": { es: "Activar y desactivar las opciones de la clínica" },
  "Tokens de API, webhooks e integrações": { es: "Tokens de API, webhooks e integraciones" },
  "Ver pedidos LGPD": { es: "Ver solicitudes LGPD" },
  "Aprovar pedidos e anonimizar titulares": { es: "Aprobar solicitudes y anonimizar titulares" },
  "Ver o registro de auditoria": { es: "Ver el registro de auditoría" },
  "Ver extensões disponíveis": { es: "Ver extensiones disponibles" },
  "Ativar, configurar e desativar extensões": { es: "Activar, configurar y desactivar extensiones" },
  "Confirme a verificação em duas etapas para mexer em papéis de acesso.": { es: "Confirme la verificación en dos pasos para modificar roles de acceso." },
  "Você só pode dar permissões que você mesmo tem.": { es: "Solo puede otorgar permisos que usted mismo tiene." },
  "Faltam permissões necessárias (por exemplo, \"ver\" antes de \"editar\").": { es: "Faltan permisos necesarios (por ejemplo, \"ver\" antes de \"editar\")." },
  "Permissão desconhecida.": { es: "Permiso desconocido." },
  "O papel Administrador não pode ser renomeado, desativado, excluído nem perder o controle dos papéis.": { es: "El rol Administrador no puede renombrarse, desactivarse, eliminarse ni perder el control de los roles." },
  "Este papel ainda está com membros. Tire os membros ou desative o papel.": { es: "Este rol todavía tiene miembros. Quite los miembros o desactive el rol." },
  "A empresa precisa de pelo menos um membro com o papel Administrador.": { es: "La empresa necesita al menos un miembro con el rol Administrador." },
  "Papel não encontrado.": { es: "Rol no encontrado." },
  "Já existe um papel com este nome.": { es: "Ya existe un rol con este nombre." },
  "O acesso desta empresa é definido pelos papéis de acesso. Altere em Configurações › Papéis de acesso.": { es: "El acceso de esta empresa se define por los roles de acceso. Cámbielo en Configuración › Roles de acceso." },
  // ── FORK clinic (E6): indicadores da agenda ──
  "Indicadores da agenda": { es: "Indicadores de la agenda" },
  "Ver indicadores da agenda": { es: "Ver indicadores de la agenda" },
  "Faltas, ocupação de cada profissional, espera na recepção e confirmação pelo WhatsApp.": { es: "Ausencias, ocupación de cada profesional, espera en recepción y confirmación por WhatsApp." },
  "Comparecimento, faltas, ocupação de cada profissional, espera na recepção e resultado da confirmação, no período escolhido.": { es: "Asistencia, ausencias, ocupación de cada profesional, espera en recepción y resultado de la confirmación, en el período elegido." },
  "Só gerentes e administradores veem os indicadores.": { es: "Solo gerentes y administradores ven los indicadores." },
  "Não foi possível carregar os indicadores.": { es: "No fue posible cargar los indicadores." },
  "Taxa de faltas": { es: "Tasa de ausencias" },
  "Sem registro": { es: "Sin registro" },
  "Compromissos passados sem \"Compareceu\" nem \"Faltou\".": { es: "Citas pasadas sin \"Asistió\" ni \"No asistió\"." },
  "Espera média na recepção": { es: "Espera media en recepción" },
  "Atendimento médio": { es: "Atención media" },
  "Confirmaram pelo WhatsApp": { es: "Confirmaron por WhatsApp" },
  "pediram para remarcar": { es: "pidieron reprogramar" },
  "Agendados": { es: "Agendados" },
  "Realizados": { es: "Realizados" },
  "Ocupação": { es: "Ocupación" },
  "Ocupação = tempo marcado ÷ jornada publicada no período. Bloqueios e exceções não descontam da jornada.": { es: "Ocupación = tiempo agendado ÷ jornada publicada en el período. Bloqueos y excepciones no descuentan de la jornada." },
  ...
  "Salas e equipamentos desligados": { es: "Salas y equipos desactivados" },
  "A agenda só oferece horário com a sala e o equipamento que o atendimento exige livres, e reserva os dois ao marcar.": { es: "La agenda solo ofrece horarios con la sala y el equipo que la atención exige libres, y reserva ambos al agendar." },
  "Ligue para a agenda considerar salas e equipamentos. Você pode cadastrá-los antes na aba Salas e equipamentos.": { es: "Actívelo para que la agenda considere salas y equipos. Puede registrarlos antes en la pestaña Salas y equipos." },
  "Cadastre as salas e os equipamentos. A categoria agrupa os que servem para a mesma coisa (ex.: Sala).": { es: "Registre las salas y los equipos. La categoría agrupa los que sirven para lo mismo (ej.: Sala)." },
  "Nenhuma sala ou equipamento cadastrado.": { es: "Ninguna sala o equipo registrado." },
  "O que cada atendimento exige": { es: "Lo que exige cada atención" },
  "A agenda, a tela de marcar e o agente de IA só oferecem horário com sala e equipamento livres, e o compromisso já reserva os dois.": { es: "La agenda, la pantalla de agendar y el agente de IA solo ofrecen horarios con sala y equipo libres, y la cita ya reserva ambos." },
  "Não exige sala nem equipamento.": { es: "No exige sala ni equipo." },
  "Uma de": { es: "Una de" },
  "Recurso removido": { es: "Recurso eliminado" },
  "Remover exigência": { es: "Quitar exigencia" },
  "Exigir sala ou equipamento": { es: "Exigir sala o equipo" },
  "Exigir…": { es: "Exigir…" },
  "Sala e equipamento": { es: "Sala y equipo" },
  "Informe o nome e a categoria.": { es: "Informe el nombre y la categoría." },
  "Já existe uma sala ou equipamento com este nome.": { es: "Ya existe una sala o equipo con este nombre." },
  "Sala ou equipamento não encontrado.": { es: "Sala o equipo no encontrado." },
  "Lista de salas e equipamentos inválida.": { es: "Lista de salas y equipos inválida." },
  "Alguma sala ou equipamento não existe nesta empresa.": { es: "Alguna sala o equipo no existe en esta empresa." },
  "Não há sala ou equipamento livre para este atendimento neste horário. Consulte os horários livres e escolha outro.": { es: "No hay sala o equipo libre para esta atención en este horario. Consulte los horarios libres y elija otro." },
  ...
  "Agendado": { es: "Agendado" },
  "Na recepção": { es: "En recepción" },
  "Pronto para atendimento": { es: "Listo para atención" },
  "Finalizado": { es: "Finalizado" },
  "Iniciar atendimento": { es: "Iniciar atención" },
  "Finalizar atendimento": { es: "Finalizar atención" },
  "Status da visita": { es: "Estado de la visita" },
  "Corrigir status": { es: "Corregir estado" },
  "Novo status": { es: "Nuevo estado" },
  "Motivo da correção (obrigatório)": { es: "Motivo de la corrección (obligatorio)" },
  "Motivo da correção": { es: "Motivo de la corrección" },
  "Salvar status": { es: "Guardar estado" },
  "correção": { es: "corrección" },
  "Sem profissional": { es: "Sin profesional" },
  "Não foi possível carregar os pacientes de hoje.": { es: "No fue posible cargar los pacientes de hoy." },
  "Nenhum paciente agendado para hoje.": { es: "Ningún paciente agendado para hoy." },
  ...
  // ── FORK clinic (9014): menu por módulos da clínica ──
  "Todos os módulos da clínica num lugar só, com o resumo do dia.": { es: "Todos los módulos de la clínica en un solo lugar, con el resumen del día." },
  "Horários, chegada dos pacientes, faltas e a ocupação de cada profissional.": { es: "Horarios, llegada de los pacientes, ausencias y la ocupación de cada profesional." },
  "O dia da agenda": { es: "El día de la agenda" },
  "Indicadores": { es: "Indicadores" },
  "Ajustes da agenda": { es: "Ajustes de la agenda" },
  "Conversas com pacientes pelo WhatsApp e telefone, com a IA ao lado.": { es: "Conversaciones con pacientes por WhatsApp y teléfono, con la IA al lado." },
  "Cadastro, ficha e a jornada de cada paciente, do primeiro contato ao retorno.": { es: "Registro, ficha y el recorrido de cada paciente, del primer contacto al regreso." },
  "Jornada do paciente": { es: "Recorrido del paciente" },
  "Prontuário": { es: "Historia clínica" },
  "Anamnese, evolução e assinatura do atendimento.": { es: "Anamnesis, evolución y firma de la atención." },
  "Fotos antes e depois": { es: "Fotos antes y después" },
  "Registro fotográfico por sessão, com consentimento.": { es: "Registro fotográfico por sesión, con consentimiento." },
  "Contratos": { es: "Contratos" },
  "Contratos e termos dos tratamentos, assinados pelo paciente.": { es: "Contratos y términos de los tratamientos, firmados por el paciente." },
  "Contratos e termos": { es: "Contratos y términos" },
  "Modelos de contrato por procedimento e pacote.": { es: "Modelos de contrato por procedimiento y paquete." },
  "Assinatura digital": { es: "Firma digital" },
  "O paciente assina pelo celular, com validade jurídica.": { es: "El paciente firma desde el celular, con validez jurídica." },
  "Pedidos dos titulares sobre os próprios dados, com prazo e histórico.": { es: "Solicitudes de los titulares sobre sus propios datos, con plazo e historial." },
  "Pedidos dos titulares": { es: "Solicitudes de los titulares" },
  "Termos de uso de imagem e de dados aceitos por paciente.": { es: "Términos de uso de imagen y de datos aceptados por paciente." },
  "O que a clínica oferece, com preço e duração.": { es: "Lo que ofrece la clínica, con precio y duración." },
  "Protocolos": { es: "Protocolos" },
  "Sessões, intervalos e cuidados de cada tratamento.": { es: "Sesiones, intervalos y cuidados de cada tratamiento." },
  "Pacotes": { es: "Paquetes" },
  "Sessões vendidas juntas, com saldo por paciente.": { es: "Sesiones vendidas juntas, con saldo por paciente." },
  "Equipamentos": { es: "Equipos" },
  "Aparelhos da clínica, uso por procedimento e manutenção.": { es: "Aparatos de la clínica, uso por procedimiento y mantenimiento." },
  "Cadastro dos aparelhos e de onde cada um está.": { es: "Registro de los aparatos y dónde está cada uno." },
  "Manutenções": { es: "Mantenimientos" },
  "Revisões e calibrações com aviso de vencimento.": { es: "Revisiones y calibraciones con aviso de vencimiento." },
  "Quem atende, com especialidades, bloqueios e salas.": { es: "Quién atiende, con especialidades, bloqueos y salas." },
  "Equipe clínica": { es: "Equipo clínico" },
  "Escalas": { es: "Turnos" },
  "Turnos e folgas de cada profissional.": { es: "Turnos y francos de cada profesional." },
  "Comandas, recebimentos e o faturamento da clínica.": { es: "Comandas, cobros y la facturación de la clínica." },
  "O dia do caixa": { es: "El día de la caja" },
  "Ajustes do financeiro": { es: "Ajustes de finanzas" },
  "Contas a pagar e a receber": { es: "Cuentas por pagar y por cobrar" },
  "Vencimentos, baixas e fluxo de caixa.": { es: "Vencimientos, cancelaciones y flujo de caja." },
  "Comissões": { es: "Comisiones" },
  "Quanto cada profissional recebe por atendimento e venda.": { es: "Cuánto recibe cada profesional por atención y venta." },
  "Regras de comissão": { es: "Reglas de comisión" },
  "Percentual ou valor fixo por procedimento e profissional.": { es: "Porcentaje o valor fijo por procedimiento y profesional." },
  "Extrato": { es: "Extracto" },
  "O que cada profissional tem a receber no período.": { es: "Lo que cada profesional tiene por cobrar en el período." },
  "Notas fiscais": { es: "Facturas" },
  "Emissão de nota de serviço a partir do atendimento pago.": { es: "Emisión de factura de servicio a partir de la atención pagada." },
  "Emissão de NFS-e": { es: "Emisión de NFS-e" },
  "Nota de serviço emitida pela prefeitura, sem redigitar.": { es: "Factura de servicio emitida por la municipalidad, sin volver a digitar." },
  "O que precisa ser feito, por quem e até quando.": { es: "Lo que hay que hacer, quién y hasta cuándo." },
  "Marketing": { es: "Marketing" },
  "Campanhas, anúncios e a busca de novos pacientes.": { es: "Campañas, anuncios y la búsqueda de nuevos pacientes." },
  "Anúncios": { es: "Anuncios" },
  "O assistente que atende, agenda e faz follow-up pelos pacientes.": { es: "El asistente que atiende, agenda y hace seguimiento de los pacientes." },
  "Perfil e acesso": { es: "Perfil y acceso" },
  "Sua conta, a equipe, os papéis de acesso e o registro de quem fez o quê.": { es: "Tu cuenta, el equipo, los roles de acceso y el registro de quién hizo qué." },
  "Equipe e acesso": { es: "Equipo y acceso" },
  "Dados da clínica, canais de atendimento, marca e integrações.": { es: "Datos de la clínica, canales de atención, marca e integraciones." },
  "Sua clínica": { es: "Tu clínica" },
  "Dados e integrações": { es: "Datos e integraciones" },
  "Em breve": { es: "Próximamente" },
  "Ver tudo": { es: "Ver todo" },
  "Módulos": { es: "Módulos" },
  "Módulos da clínica": { es: "Módulos de la clínica" },
  "1 tela": { es: "1 pantalla" },
  "telas": { es: "pantallas" },
  "Resumo do dia": { es: "Resumen del día" },
  "Atendimentos hoje": { es: "Atenciones hoy" },
  "Faltas hoje": { es: "Ausencias hoy" },
  "Tarefas para hoje ou atrasadas": { es: "Tareas para hoy o atrasadas" },
  "Suas conversas não lidas": { es: "Tus conversaciones no leídas" },
  "Seu acesso não inclui telas deste módulo. Fale com quem administra a clínica.": { es: "Tu acceso no incluye pantallas de este módulo. Habla con quien administra la clínica." },
  "Menu organizado por módulos da clínica": { es: "Menú organizado por módulos de la clínica" },
  "Experimente o menu da clínica": { es: "Prueba el menú de la clínica" },
  "Todas as telas continuam onde a equipe tem acesso. Desligue para voltar ao menu anterior.": { es: "Todas las pantallas siguen donde el equipo tiene acceso. Desactívalo para volver al menú anterior." },
  "O menu lateral passa a mostrar Agenda, Pacientes, Financeiro e os demais módulos. Nenhum acesso muda.": { es: "El menú lateral pasa a mostrar Agenda, Pacientes, Finanzas y los demás módulos. Ningún acceso cambia." },
  "Voltar ao menu anterior": { es: "Volver al menú anterior" },
  "Ligar o menu da clínica": { es: "Activar el menú de la clínica" },
  ...
  "Aguardando atendimento": { es: "Esperando atención" },
  "Anulado": { es: "Anulado" },
  "Mostrar": { es: "Mostrar" },
  "Meus": { es: "Míos" },
  "Todos os profissionais": { es: "Todos los profesionales" },
  "O módulo de prontuário está desligado nesta clínica. Quem administra pode ligá-lo nas opções da clínica.": { es: "El módulo de historia clínica está desactivado en esta clínica. Quien administra puede activarlo en las opciones de la clínica." },
  "Não foi possível carregar a fila de atendimentos.": { es: "No fue posible cargar la fila de atenciones." },
  "Ninguém por aqui.": { es: "Nadie por aquí." },
  "espera": { es: "espera" },
  "Continuar atendimento": { es: "Continuar atención" },
  "Não foi possível abrir o atendimento.": { es: "No fue posible abrir la atención." },
  "Idade não informada": { es: "Edad no informada" },
  "início": { es: "inicio" },
  "fim": { es: "fin" },
  "Finalizando…": { es: "Finalizando…" },
  "Registros do atendimento": { es: "Registros de la atención" },
  "Os registros clínicos chegam na próxima etapa do módulo. O atendimento já fica registrado com paciente, profissional, horário e status.": { es: "Los registros clínicos llegan en la próxima etapa del módulo. La atención ya queda registrada con paciente, profesional, horario y estado." },
  ...
  "Anexos": { es: "Anexos" },
  "O profissional inicia pela fila de atendimentos": { es: "El profesional inicia desde la fila de atenciones" },
  "O profissional finaliza pela fila de atendimentos": { es: "El profesional finaliza desde la fila de atenciones" },
  "Com o prontuário ligado, o profissional inicia o atendimento pela fila dele.": { es: "Con la historia clínica activada, el profesional inicia la atención desde su fila." },
  "Este atendimento está aberto: o profissional finaliza pela fila dele.": { es: "Esta atención está abierta: el profesional la finaliza desde su fila." },
  "O módulo de prontuário está desligado nesta clínica.": { es: "El módulo de historia clínica está desactivado en esta clínica." },
  "Atendimento não encontrado.": { es: "Atención no encontrada." },
  "Este agendamento foi cancelado ou o paciente faltou.": { es: "Esta cita fue cancelada o el paciente faltó." },
  "Escolha uma especialidade que você atende.": { es: "Elija una especialidad que usted atiende." },
  "Este atendimento já foi encerrado.": { es: "Esta atención ya fue cerrada." },
  ...
  "Nada registrado.": { es: "Nada registrado." },
  "Obrigatório para finalizar.": { es: "Obligatorio para finalizar." },
  "Adendos": { es: "Adendas" },
  "Adendo": { es: "Adenda" },
  "Adicionar adendo": { es: "Agregar adenda" },
  "O registro original continua como está. O adendo fica ao lado dele, com o seu nome e a data.": { es: "El registro original queda como está. La adenda queda al lado, con su nombre y la fecha." },
  "Registrar adendo": { es: "Registrar adenda" },
  "Escolha o modelo para começar.": { es: "Elija el modelo para comenzar." },
  "Resposta apresentada": { es: "Respuesta presentada" },
  "Intercorrências": { es: "Complicaciones" },
  "Orientações": { es: "Indicaciones" },
  "Próxima conduta": { es: "Próxima conducta" },
  "A evolução é obrigatória para finalizar.": { es: "La evolución es obligatoria para finalizar." },
  "Ver prontuário completo": { es: "Ver historia clínica completa" },
  "Falta preencher para finalizar:": { es: "Falta completar para finalizar:" },
  "Seções do atendimento": { es: "Secciones de la atención" },
  "preenchida": { es: "completada" },
  "vazia": { es: "vacía" },
  "Documentos": { es: "Documentos" },
  "Não foi possível carregar os registros.": { es: "No fue posible cargar los registros." },
  "Não foi possível abrir o prontuário.": { es: "No fue posible abrir la historia clínica." },
  "Nenhum atendimento registrado para este paciente.": { es: "Ninguna atención registrada para este paciente." },
  "Seção inválida.": { es: "Sección inválida." },
  "Respostas inválidas.": { es: "Respuestas inválidas." },
  "Modelo de formulário inválido para esta seção.": { es: "Modelo de formulario inválido para esta sección." },
  "Escreva o adendo e o motivo (mínimo de 3 letras).": { es: "Escriba la adenda y el motivo (mínimo 3 letras)." },
  "Não foi possível ler o prontuário.": { es: "No fue posible leer la historia clínica." },
  "Faltam registros obrigatórios para finalizar o atendimento.": { es: "Faltan registros obligatorios para finalizar la atención." },
  "Outra pessoa alterou este registro. Recarregue para ver a versão mais nova.": { es: "Otra persona modificó este registro. Recargue para ver la versión más nueva." },
  "Registro finalizado não pode ser alterado. Use um adendo.": { es: "Un registro finalizado no puede modificarse. Use una adenda." },
  "Adendo só vale para atendimento finalizado. Enquanto está aberto, edite o registro.": { es: "La adenda solo vale para atención finalizada. Mientras está abierta, edite el registro." },
  "O registro do adendo não é deste atendimento.": { es: "El registro de la adenda no es de esta atención." },
  "Informe o motivo do adendo.": { es: "Informe el motivo de la adenda." },
  "Anamnese geral": { es: "Anamnesis general" },
  "Anamnese estética": { es: "Anamnesis estética" },
  "Avaliação geral": { es: "Evaluación general" },
  "Avaliação estética facial": { es: "Evaluación estética facial" },
  "Avaliação corporal": { es: "Evaluación corporal" },
  "Para qualquer atendimento.": { es: "Para cualquier atención." },
  "Procedimentos estéticos faciais e corporais.": { es: "Procedimientos estéticos faciales y corporales." },
  "Pele e face.": { es: "Piel y rostro." },
  "Regiões do corpo.": { es: "Regiones del cuerpo." },
  "Queixa principal": { es: "Motivo de consulta" },
  "Objetivo do paciente": { es: "Objetivo del paciente" },
  "Histórico relevante": { es: "Antecedentes relevantes" },
  "Informa alergias?": { es: "¿Informa alergias?" },
  "Alergias informadas": { es: "Alergias informadas" },
  "Somente o que o paciente informou.": { es: "Solo lo que informó el paciente." },
  "Medicamentos em uso": { es: "Medicamentos en uso" },
  "Procedimentos anteriores": { es: "Procedimientos anteriores" },
  "Hábitos": { es: "Hábitos" },
  "Tabagismo": { es: "Tabaquismo" },
  "Consumo de álcool": { es: "Consumo de alcohol" },
  "Atividade física regular": { es: "Actividad física regular" },
  "Exposição solar frequente": { es: "Exposición solar frecuente" },
  "Observações do profissional": { es: "Observaciones del profesional" },
  "Procedimentos estéticos anteriores": { es: "Procedimientos estéticos anteriores" },
  "Usa ácidos ou retinoides?": { es: "¿Usa ácidos o retinoides?" },
  "Exposição solar": { es: "Exposición solar" },
  "Moderada": { es: "Moderada" },
  "Gestação ou amamentação": { es: "Embarazo o lactancia" },
  "Gestante": { es: "Embarazada" },
  "Amamentando": { es: "Amamantando" },
  "Não se aplica": { es: "No aplica" },
  "Histórico de queloide ou cicatrização difícil?": { es: "¿Antecedentes de queloide o cicatrización difícil?" },
  "Achados da avaliação": { es: "Hallazgos de la evaluación" },
  "Contraindicações identificadas": { es: "Contraindicaciones identificadas" },
  "Fototipo (Fitzpatrick)": { es: "Fototipo (Fitzpatrick)" },
  "Tipo de pele": { es: "Tipo de piel" },
  "Seca": { es: "Seca" },
  "Normal": { es: "Normal" },
  "Oleosa": { es: "Grasa" },
  "Mista": { es: "Mixta" },
  "Sensível": { es: "Sensible" },
  "Achados": { es: "Hallazgos" },
  "Acne": { es: "Acné" },
  "Manchas": { es: "Manchas" },
  "Rugas e linhas": { es: "Arrugas y líneas" },
  "Flacidez": { es: "Flacidez" },
  "Poros dilatados": { es: "Poros dilatados" },
  "Cicatrizes": { es: "Cicatrices" },
  "Descrição da avaliação": { es: "Descripción de la evaluación" },
  "Regiões avaliadas": { es: "Regiones evaluadas" },
  "Abdômen": { es: "Abdomen" },
  "Flancos": { es: "Flancos" },
  "Coxas": { es: "Muslos" },
  "Glúteos": { es: "Glúteos" },
  "Braços": { es: "Brazos" },
  "Costas": { es: "Espalda" },
  "Gordura localizada": { es: "Grasa localizada" },
  "Celulite": { es: "Celulitis" },
  "Estrias": { es: "Estrías" },
  "Peso (kg)": { es: "Peso (kg)" },
  "Altura (cm)": { es: "Altura (cm)" },
  // ── FORK clinic (9020): modelos clínicos e requisitos ──
  "Editar modelo": { es: "Editar modelo" },
  "Novo modelo": { es: "Nuevo modelo" },
  "Seção": { es: "Sección" },
  "Sem nenhuma marcada, o modelo aparece para todas.": { es: "Si no marca ninguna, el modelo aparece para todas." },
  "Nenhuma especialidade cadastrada.": { es: "Ninguna especialidad registrada." },
  "Modelo ativo": { es: "Modelo activo" },
  "Modelo ativo (aparece para escolher no atendimento)": { es: "Modelo activo (aparece para elegir en la atención)" },
  "Salvar dados do modelo": { es: "Guardar datos del modelo" },
  "Campos": { es: "Campos" },
  "Mudar os campos publica uma versão nova. Quem já preencheu continua vendo a versão que usou.": { es: "Cambiar los campos publica una versión nueva. Quien ya completó sigue viendo la versión que usó." },
  "Pergunta": { es: "Pregunta" },
  "Tipo de resposta": { es: "Tipo de respuesta" },
  "Opções (uma por linha)": { es: "Opciones (una por línea)" },
  "Mínimo": { es: "Mínimo" },
  "Máximo": { es: "Máximo" },
  "Ajuda (opcional)": { es: "Ayuda (opcional)" },
  "Obrigatório para finalizar": { es: "Obligatorio para finalizar" },
  "Publicar nova versão": { es: "Publicar nueva versión" },
  "Prévia": { es: "Vista previa" },
  "Assim o profissional verá o formulário. Nada aqui é salvo.": { es: "Así verá el formulario el profesional. Nada aquí se guarda." },
  "Adicione campos para ver a prévia.": { es: "Agregue campos para ver la vista previa." },
  "Não foi possível carregar os requisitos.": { es: "No fue posible cargar los requisitos." },
  "O que precisa estar preenchido para o profissional finalizar o atendimento. A evolução é sempre obrigatória.": { es: "Lo que debe estar completado para que el profesional finalice la atención. La evolución siempre es obligatoria." },
  "todos os atendimentos": { es: "todas las atenciones" },
  "sempre": { es: "siempre" },
  "Exigir": { es: "Exigir" },
  "Tipo de atendimento": { es: "Tipo de atención" },
  "Salvar requisitos": { es: "Guardar requisitos" },
  "Não foi possível carregar os modelos.": { es: "No fue posible cargar los modelos." },
  "Nenhum modelo.": { es: "Ningún modelo." },
  "Cópia de": { es: "Copia de" },
  "Requisitos para finalizar": { es: "Requisitos para finalizar" },
  "Os formulários de anamnese e avaliação que os profissionais preenchem, e o que é obrigatório para finalizar um atendimento.": { es: "Los formularios de anamnesis y evaluación que completan los profesionales, y lo que es obligatorio para finalizar una atención." },
  "Os campos do modelo são inválidos: confira chaves, tipos e especialidades.": { es: "Los campos del modelo son inválidos: revise claves, tipos y especialidades." },
  "Já existe um modelo com este nome.": { es: "Ya existe un modelo con este nombre." },
  "Modelo não encontrado.": { es: "Modelo no encontrado." },
  "Regras inválidas: confira o tipo de atendimento e a especialidade.": { es: "Reglas inválidas: revise el tipo de atención y la especialidad." },
  "Texto curto": { es: "Texto corto" },
  "Texto longo": { es: "Texto largo" },
  "Sim ou não": { es: "Sí o no" },
  "Escolha única": { es: "Opción única" },
  "Múltipla escolha": { es: "Opción múltiple" },
  "Escala": { es: "Escala" },
  "Um modelo tem de 1 a 60 campos.": { es: "Un modelo tiene de 1 a 60 campos." },
  "Escolha e múltipla escolha precisam de opções.": { es: "Opción única y múltiple necesitan opciones." },
  "Na escala, o mínimo precisa ser menor que o máximo.": { es: "En la escala, el mínimo debe ser menor que el máximo." },
  "Opção repetida.": { es: "Opción repetida." },
  "Chave de campo repetida.": { es: "Clave de campo repetida." },
  "Formulários de anamnese e avaliação e o que é obrigatório para finalizar um atendimento.": { es: "Formularios de anamnesis y evaluación y lo que es obligatorio para finalizar una atención." },
  // ── FORK clinic (9021): conduta e planos de tratamento ──
  "Não foi possível carregar os planos.": { es: "No fue posible cargar los planes." },
  "Novo plano a partir desta conduta": { es: "Nuevo plan a partir de esta conducta" },
  "Novo plano": { es: "Nuevo plan" },
  "Nenhum plano de tratamento.": { es: "Ningún plan de tratamiento." },
  "Título do plano": { es: "Título del plan" },
  "Objetivo": { es: "Objetivo" },
  "Previsão de término": { es: "Previsión de término" },
  "Criar plano": { es: "Crear plan" },
  "realizadas": { es: "realizadas" },
  "agendadas": { es: "agendadas" },
  "Mudar status do plano": { es: "Cambiar estado del plan" },
  "Nenhuma sessão ainda.": { es: "Ninguna sesión todavía." },
  "Adicionar sessões": { es: "Agregar sesiones" },
  "Sessão": { es: "Sesión" },
  "Agendada para": { es: "Agendada para" },
  "Realizada em": { es: "Realizada el" },
  "Previsão": { es: "Previsión" },
  "Agendamento para esta sessão": { es: "Cita para esta sesión" },
  "Escolha o agendamento": { es: "Elija la cita" },
  "Desligar agendamento": { es: "Desvincular cita" },
  "Motivo do cancelamento da sessão": { es: "Motivo de la cancelación de la sesión" },
  "Cancelar sessão": { es: "Cancelar sesión" },
  "Descrição da sessão": { es: "Descripción de la sesión" },
  "Serviço (opcional)": { es: "Servicio (opcional)" },
  "Primeira sessão prevista": { es: "Primera sesión prevista" },
  "Intervalo entre sessões (dias)": { es: "Intervalo entre sesiones (días)" },
  "A conduta é obrigatória para finalizar este atendimento.": { es: "La conducta es obligatoria para finalizar esta atención." },
  "Conduta definida": { es: "Conducta definida" },
  "Protocolo": { es: "Protocolo" },
  "Recomendações": { es: "Recomendaciones" },
  "Planos": { es: "Planes" },
  "Paciente inválido para este plano.": { es: "Paciente inválido para este plan." },
  "Plano não encontrado.": { es: "Plan no encontrado." },
  "Sessão não encontrada.": { es: "Sesión no encontrada." },
  "Este plano está concluído ou cancelado.": { es: "Este plan está concluido o cancelado." },
  "Esta sessão já foi realizada ou cancelada.": { es: "Esta sesión ya fue realizada o cancelada." },
  "O agendamento precisa ser deste paciente e não pode estar cancelado.": { es: "La cita debe ser de este paciente y no puede estar cancelada." },
  "Este agendamento já está ligado a outra sessão.": { es: "Esta cita ya está vinculada a otra sesión." },
  "Informe o motivo do cancelamento.": { es: "Informe el motivo de la cancelación." },
  ...
  // ── FORK clinic (9023): documentos, termos e aceite ──
  "Não foi possível carregar os documentos.": { es: "No fue posible cargar los documentos." },
  "Nenhum documento emitido.": { es: "Ningún documento emitido." },
  "Escolha o modelo": { es: "Elija el modelo" },
  "Procedimento (aparece no texto)": { es: "Procedimiento (aparece en el texto)" },
  "Emitir": { es: "Emitir" },
  "Motivo da revogação": { es: "Motivo de la revocación" },
  "emitido em": { es: "emitido el" },
  "válido até": { es: "válido hasta" },
  "Aceito por": { es: "Aceptado por" },
  "pelo link": { es: "por el enlace" },
  "presencial": { es: "presencial" },
  "sim": { es: "sí" },
  "não": { es: "no" },
  "Ocultar texto": { es: "Ocultar texto" },
  "Ver texto": { es: "Ver texto" },
  "Colher aceite aqui": { es: "Tomar la aceptación aquí" },
  "Gerar link para o paciente": { es: "Generar enlace para el paciente" },
  "Envie este link ao paciente. Ele vale uma vez só, até": { es: "Envíe este enlace al paciente. Sirve una sola vez, hasta" },
  "Link de aceite": { es: "Enlace de aceptación" },
  "Os textos que vêm prontos são modelos para adaptar. Revise-os com o advogado ou advogada da clínica antes de usar.": { es: "Los textos que vienen listos son modelos para adaptar. Revíselos con el abogado o la abogada de la clínica antes de usarlos." },
  "opções": { es: "opciones" },
  "Marcadores disponíveis:": { es: "Marcadores disponibles:" },
  "Marcadores que o sistema não conhece:": { es: "Marcadores que el sistema no conoce:" },
  "Opções que o paciente marca (sim ou não)": { es: "Opciones que marca el paciente (sí o no)" },
  "Opção": { es: "Opción" },
  "Adicionar opção": { es: "Agregar opción" },
  "Modelo ativo (aparece para emitir)": { es: "Modelo activo (aparece para emitir)" },
  "Mudar o texto ou as opções publica uma versão nova. Quem já aceitou continua ligado à versão que aceitou.": { es: "Cambiar el texto o las opciones publica una versión nueva. Quien ya aceptó sigue vinculado a la versión que aceptó." },
  "Responda cada item:": { es: "Responda cada ítem:" },
  "Sim, autorizo": { es: "Sí, autorizo" },
  "Não autorizo": { es: "No autorizo" },
  "Nome completo de quem aceita": { es: "Nombre completo de quien acepta" },
  "Ao confirmar, fica registrado que você leu e aceitou este texto, com data, hora e o dispositivo usado.": { es: "Al confirmar, queda registrado que usted leyó y aceptó este texto, con fecha, hora y el dispositivo usado." },
  "Li e aceito": { es: "Leí y acepto" },
  "Pronto! Seu aceite foi registrado. Você já pode fechar esta página.": { es: "¡Listo! Su aceptación fue registrada. Ya puede cerrar esta página." },
  "Não foi possível abrir o termo.": { es: "No fue posible abrir el término." },
  "Não foi possível registrar o aceite. O link pode ter expirado.": { es: "No fue posible registrar la aceptación. El enlace puede haber vencido." },
  "Este link expirou ou já foi usado. Peça um novo à clínica.": { es: "Este enlace venció o ya fue usado. Pida uno nuevo a la clínica." },
  "Muitas tentativas. Tente de novo em alguns minutos.": { es: "Demasiados intentos. Intente de nuevo en unos minutos." },
  "Um termo aceito, ligado a este atendimento, é obrigatório para finalizar.": { es: "Un término aceptado, vinculado a esta atención, es obligatorio para finalizar." },
  "Aguardando aceite": { es: "Esperando aceptación" },
  "Modelo de documento inválido.": { es: "Modelo de documento inválido." },
  "Documento emitido não pode ser alterado.": { es: "Un documento emitido no puede modificarse." },
  "Não foi possível emitir: confira o paciente e o modelo.": { es: "No fue posible emitir: revise el paciente y el modelo." },
  "Documento não encontrado.": { es: "Documento no encontrado." },
  "Este documento já foi respondido, revogado ou cancelado.": { es: "Este documento ya fue respondido, revocado o cancelado." },
  "Digite o nome completo de quem aceita.": { es: "Escriba el nombre completo de quien acepta." },
  "Responda sim ou não em cada opção. As obrigatórias precisam estar marcadas.": { es: "Responda sí o no en cada opción. Las obligatorias deben estar marcadas." },
  "Informe o motivo.": { es: "Informe el motivo." },
  "Este link expirou ou já foi usado.": { es: "Este enlace venció o ya fue usado." },
  "Modelo ou paciente não encontrado.": { es: "Modelo o paciente no encontrado." },
  "Termo de consentimento": { es: "Término de consentimiento" },
  "Autorização": { es: "Autorización" },
  "Uso de imagem": { es: "Uso de imagen" },
  "Ciência de orientações": { es: "Constancia de indicaciones" },
  "Termo de consentimento para procedimento": { es: "Término de consentimiento para procedimiento" },
  "Ciência das orientações pós-procedimento": { es: "Constancia de las indicaciones posprocedimiento" },
  "Contrato de prestação de serviços": { es: "Contrato de prestación de servicios" },
  "Autorização de atendimento de menor de idade": { es: "Autorización de atención de menor de edad" },
  "Autorização de uso de imagem": { es: "Autorización de uso de imagen" },
  "Termo": { es: "Término" },
  "Link inválido.": { es: "Enlace inválido." },
  // ── FORK clinic (9024): anexos e fotos ──
  "Não foi possível carregar os arquivos.": { es: "No fue posible cargar los archivos." },
  "Espaço usado pela clínica": { es: "Espacio usado por la clínica" },
  "Espaço da clínica:": { es: "Espacio de la clínica:" },
  "quase cheio": { es: "casi lleno" },
  "Filtrar": { es: "Filtrar" },
  "Fotos": { es: "Fotos" },
  "Limpar comparação": { es: "Limpiar comparación" },
  "Comparar fotos": { es: "Comparar fotos" },
  "Foto clínica": { es: "Foto clínica" },
  "Nenhum arquivo.": { es: "Ningún archivo." },
  "Foto": { es: "Foto" },
  "Comparar": { es: "Comparar" },
  "Motivo para anular este arquivo": { es: "Motivo para anular este archivo" },
  "Uso da imagem": { es: "Uso de la imagen" },
  "Só uso clínico": { es: "Solo uso clínico" },
  "Fotos são de uso clínico. Para usar em divulgação ou ensino, o paciente precisa aceitar a autorização de uso de imagem (aba Documentos).": { es: "Las fotos son de uso clínico. Para usarlas en divulgación o enseñanza, el paciente debe aceptar la autorización de uso de imagen (pestaña Documentos)." },
  "Enviando": { es: "Enviando" },
  "Documento (PDF)": { es: "Documento (PDF)" },
  "Momento": { es: "Momento" },
  "Escolher arquivos": { es: "Elegir archivos" },
  "A foto é reduzida e convertida no próprio aparelho antes de enviar; localização e dados da câmera são descartados.": { es: "La foto se reduce y se convierte en el propio dispositivo antes de enviarse; la ubicación y los datos de la cámara se descartan." },
  "PDF de até 10 MB.": { es: "PDF de hasta 10 MB." },
  "Fotos e anexos": { es: "Fotos y adjuntos" },
  "Antes": { es: "Antes" },
  "Durante": { es: "Durante" },
  "Depois": { es: "Después" },
  "Acompanhamento": { es: "Seguimiento" },
  "Ensino, sem identificação": { es: "Enseñanza, sin identificación" },
  "Divulgação sem mostrar o rosto": { es: "Divulgación sin mostrar el rostro" },
  "Divulgação com identificação": { es: "Divulgación con identificación" },
  "Arquivo inválido para este paciente.": { es: "Archivo inválido para este paciente." },
  "A clínica atingiu o limite de espaço para arquivos. Fale com quem administra o sistema.": { es: "La clínica alcanzó el límite de espacio para archivos. Hable con quien administra el sistema." },
  "Arquivo não encontrado.": { es: "Archivo no encontrado." },
  "O paciente não autorizou este uso da imagem (ou a autorização venceu ou foi revogada).": { es: "El paciente no autorizó este uso de la imagen (o la autorización venció o fue revocada)." },
  "Envie o arquivo.": { es: "Envíe el archivo." },
  "O arquivo precisa ter até 10 MB.": { es: "El archivo debe tener hasta 10 MB." },
  "Aceitamos fotos JPG, PNG ou WebP e documentos PDF.": { es: "Aceptamos fotos JPG, PNG o WebP y documentos PDF." },
