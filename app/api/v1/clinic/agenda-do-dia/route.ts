/**
 * GET /api/v1/clinic/agenda-do-dia?dia=AAAA-MM-DD&q=… — FORK clinic (Agenda › Dia › Lista).
 *
 ...
 *
 * Alimenta a visão Dia › Lista da Agenda. Leitura (`agenda.ver`), pela sessão —
 * a RLS de quem pede vale.
 */
...
export async function GET(req: NextRequest): Promise<Response> {
  ...
  return ok({ dia: pedido, hoje, fuso, blocos, pacientes_da_busca: pacientesDaBusca }, { requestId });
}
